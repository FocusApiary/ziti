.PHONY: help lint deploy deploy-metallb sync-images sign-images store-secrets configure-services configure-keycloak configure-oidc create-identities enroll-oidc-vms patch-coredns install-tunnel
